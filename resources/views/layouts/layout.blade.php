...
{{-- <div class="container-fluid" style="background-image: url({{asset('img/test1.png')}})">
    @yield('content2')
</div>
<div class="container-fluid" style="background-image: url({{asset('img/test3.png')}})">
    @yield('content3')
</div>
<div class="container-fluid" style="background-image: url({{asset('img/test4.png')}})">
    @yield('content4')
</div>
<div class="container-fluid" style="background-image: url({{asset('img/test5.png')}})">
    @yield('content5')
</div> --}}
